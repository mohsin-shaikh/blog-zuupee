  ...
  return (
    <div className="flex items-center space-x-1">
      ...
      <div className="flex space-x-1.5">
        <Link href="https://nextjs.org?ref=mohsin-shaikh.vercel.app">
          <DevIcon type="NextJS" className="h-5 w-5" />
        </Link>
        <Link href="https://tailwindcss.com?ref=mohsin-shaikh.vercel.app">
          <DevIcon type="TailwindCSS" className="h-5 w-5" />
        </Link>
        <Link href="https://www.prisma.io?ref=mohsin-shaikh.vercel.app">
          <DevIcon type="Prisma" className="h-5 w-5" />
        </Link>
        <Link href="https://www.typescriptlang.org?ref=mohsin-shaikh.vercel.app">
          <DevIcon type="Typescript" className="h-5 w-5" />
        </Link>
        <Link href="https://umami.is?ref=mohsin-shaikh.vercel.app" className="pl-px">
